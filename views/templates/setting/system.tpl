...
<h3>テーブル接頭辞</h3>
<div class="setting">
<div class="caption">テーブル名の冒頭に追加する接頭辞です。<br />
epgrecの再インストールを旧テーブルを使用せずに行うようなケースを除き、デフォルトのままで構いません。</div>
...
<div class="setting">
<div class="caption">EPG取得に用いる録画データとXMLデータのパスを設定します。<br />
通常、この設定を変える必要はありませんが、/tmpに十分な空き容量（500MB程度）がない環境では異なるパスを設定してください。<br />
