...
Debian/Ubuntu用の設定ファイルは{$install_path}/cron.d/getepgです。Debian/Ubuntuをお使いの方は<br>
<pre>
$ sudo cp {$install_path}/cron.d/getepg /etc/cron.d/ [Enter]
</pre>
...
設定ミスが疑われる場合、<a href="{$setting->install_url}/install/step1.php">インストール設定</a>を実行し直してください。
また、手動でEPGの受信を試みるのもひとつの方法です。コンソール上で、<br>
<pre>
$ {$install_path}/getepg.php [Enter]
</pre>
<br>
と実行してください。</p>
